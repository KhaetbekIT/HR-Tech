...
export const TimeOffTabContent = () => {
    return <>
        <div className="flex gap-3 items-center justify-between pb-4 border-b-2 border-b-[#7c96b1] ">
            ...
            <div className="flex items-center gap-[30px]">
                ...
                <Button className="text-sm font-medium border border-black p-2 rounded-[8px]">
                    Add Time Off Policy
                </Button>
            </div>
        </div>
